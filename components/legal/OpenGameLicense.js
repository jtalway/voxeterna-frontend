...
const OpenGameLicense = () => {
  ...
  return (
    <div>
	<NavLink style={{cursor: "pointer"}} onClick={toggle}>Open Game License</NavLink>
      <Modal isOpen={modal} toggle={toggle}>
        <ModalHeader toggle={toggle}>Open Game License</ModalHeader>
        <ModalBody>
...
export default OpenGameLicense;